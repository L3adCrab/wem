#ifndef WEM_VECTOR_2_H
#define WEM_VECTOR_2_H
...
void wem_Vec2_clampMagnitude(Vec2 out, const Vec2 v, float maxMagnitude) {
    float sqrMag = wem_Vec2_sqrMagnitude(v);
    if (sqrMag > POW2(sqrMag)) {
        wem_Vec2_div1f(out, v, sqrtf(sqrMag));
        wem_Vec2_mul1f(out, out, maxMagnitude);
    }
    memcpy(out, v, sizeof(Vec2));
}
////////////////////////////////////////////////////////////////////////////////////////////////////
