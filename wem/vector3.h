#ifndef WEM_VECTOR_3_H
#define WEM_VECTOR_3_H
...
float wem_Vec3_sqrMagnitude(const Vec3 v) {
    #if defined(__OPTIMIZE__) && (defined(__AVX__) || defined(__SSE__))
    __m128 a, acc;
    a = _mm_load_ps(v);
    acc = _mm_mul_ps(a, a);
...
void wem_Vec3_clampMagnitude(Vec3 out, const Vec3 v, float maxMagnitude) {
    float sqrmag = wem_Vec3_sqrMagnitude(v);
    if (sqrmag > POW2(maxMagnitude)) {
        wem_Vec3_div1f(out, v, sqrtf(sqrmag));
        wem_Vec3_mul1f(out, out, maxMagnitude);
        return;
    }
    wem_Vec_cpy(out, v);
}
...
void wem_Vec3_norm(Vec3 out, const Vec3 v) {
    float mag = wem_Vec3_magnitude(v);
    wem_Vec3_div1f(out, v, mag);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////
//  POW2
/////////////////////////////////////////////////////////////////////////////////////////////////////
